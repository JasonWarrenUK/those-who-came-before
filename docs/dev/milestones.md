...
> [!TIP]
> **Goal:** Replace simple item+material pairs with blueprint-driven artefacts (parts, slots,
> constraints, per-part materials).

### Tasks

- [ ] Define artefact blueprint schema (type → slots → parts → materials, with likelihood +
...
> [!TIP]
> **Goal:** Transition from text-first UI to desk-based research interface (Strange Horticulture
> style).
