...
- [ ] **2GN.27** — `engine/generation/materials.ts` — material influence on tag accumulation (precious metals → elite/ceremonial boosts) _(depends on 2GN.20, 2GN.23 — unblocked)_
