...
- [ ] **2GN.27** — `engine/generation/materials.ts` + `engine/generation/classification.ts` —
      ...
      on 2GN.20, 2GN.75, 2GN.78, 2GN.82, 2GN.83, 2GN.84, 2GN.85, 2GN.110, 2GN.97, 2GN.142 — all
