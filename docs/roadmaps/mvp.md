...
- [ ] **2GN.62** — Explorer: description viewer — three-register prose side by side, register
      divergence highlighting _(blocked — depends on 2GN.40, 2GN.41, 2GN.42)_
- [ ] **2GN.63** — Explorer: excavation viewer — artefacts grouped by site, ambiguity distribution
      chart _(blocked — depends on 2GN.45, 2GN.47)_
...
- [ ] **2GN.65** — Explorer: pipeline stage viewer — stage-by-stage output display _(blocked —
      depends on 2GN.56)_
- [ ] **2GN.149** — Explorer: scholars & names panel — seed → `NPCScholarSeed` cards (name,
      specialisation, career stage), sampled site/culture/scholar names per phonology,
      modern-language institution names _(depends on 2GN.48, 2GN.66, 2GN.130 — done)_
...
graph LR
	...
	2GN.149["2GN.149: Explorer: scholars & names panel — see…"]
