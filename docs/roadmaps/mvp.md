...
- [ ] **2GN.17** — `src/lib/data/classification.ts` — classification rules: feature→tag scoring, structural/container/decorative/cross-layer contributions _(depends on 1FD.12, 2GN.12 — unblocked)_
...
graph LR
	...
	10NP.22 --> M10
	10NP.23 --> M10
	class 2GN.10,2GN.22,2GN.28,2GN.35,2GN.36,2GN.37,2GN.57,2GN.66,2GN.67 todo
