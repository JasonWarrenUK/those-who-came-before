...
- [ ] **2GN.20** — `engine/generation/classification.ts` — `classifyArtefact(features, rules): Map<FunctionTag|ContextTag, number>` — rule-based scoring _(depends on 2GN.17, 2GN.19 — unblocked)_
