...
| -------- | ----------------------- | ----------------- | ----------------- |
| **FD**   | Complete                | —      | — |
| **GN**   | In progress             | 2GN.8, 2GN.17, 2GN.22 | —      |
...
2GN.6["`*2GN.6*<br/>Accumulation checking`"]:::done
2GN.7["`*2GN.7*<br/>Complexity budget`"]:::done
2GN.8["`*2GN.8*<br/>Normalisation`"]:::open
