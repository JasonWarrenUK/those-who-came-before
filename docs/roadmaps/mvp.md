...
- [ ] **2GN.27** — `engine/generation/materials.ts` + `engine/generation/classification.ts` —
      ...
      — depends on 2GN.110, 2GN.97, 2GN.142; 2GN.20, 2GN.75, 2GN.78, 2GN.82, 2GN.83, 2GN.84, 2GN.85
      all done)_ — dependency sweep 2026-07-25 corrected the 2GN.23 edge to 2GN.75 (assignments, not
...
- [ ] **2GN.68** — `engine/generation/classification.ts` — update: decorative motif and
      ...
      2GN.142; 2GN.33, 2GN.20, 2GN.82, 2GN.83, 2GN.84, 2GN.85 all done)_ — ⚠️ **rescoped 2026-08-11
